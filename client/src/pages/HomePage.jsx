...
const DEMO_HOME_SNAPSHOTS = {
    ...
    travel: {
        todayMood: {
            ...
            time: '오전 8:45',
            analysis: [
                { label: '설렘', pct: 88, color: '#FFB648' },
                { label: '개방감', pct: 76, color: '#7B7FF0' },
                { label: '활기', pct: 72, color: '#FF6B5E' },
            ],
            track: {
        ...
        recentMoods: [
            { day: '오늘', label: '기쁨', icon: I.smile, color: '#FFB648', soft: '#FFF3DE' },
            { day: '어제', label: '설렘', icon: I.sparkle, color: '#FF6B5E', soft: '#FFEAE6' },
            { day: '3일 전', label: '기쁨', icon: I.smile, color: '#FFB648', soft: '#FFF3DE' },
        ],
        recentTracks: [
            {
                trackId: 'demo-travel-1',
                cover: 'https://images.unsplash.com/photo-1470225636490-405e5d1b5c9b?w=200&q=80',
                title: 'Adventure of a Lifetime',
                artist: 'Coldplay',
                mood: '여행',
            ...
            },
            {
                ...
                moodKey: 'happy',
                moodColor: '#FFB648',
                albumName: 'When I Woke',
                durationMs: 264000,
                reason: '가볍게 들뜨는 리듬이라 여행 시작 장면에 잘 어울려요.',
                spotifyUrl: 'https://open.spotify.com',
            },
            {
                trackId: 'demo-travel-3',
