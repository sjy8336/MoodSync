...
const DEMO_QUICK_FILL = {
    focus: {
        title: '집중 예시',
        mood: 'focused',
        text: '오늘은 노트북 앞에서 오래 앉아 있을 예정이라, 너무 산만하지 않고 몰입이 이어지는 음악이 필요해요. 잔잔하지만 리듬감은 조금 있었으면 좋겠어요.',
        vibes: ['몰입되는', '차분한', '잔잔한'],
    },
    jazz: {
        title: '재즈 예시',
    ...
    drive: {
        title: '드라이브 예시',
        mood: 'excited',
        text: '주말에 차 타고 멀리 나갈 예정이에요. 창문을 열고 따라 부르기 좋고, 도로 위에서 텐션을 올려주는 팝과 펑크 음악이 듣고 싶어요.',
        vibes: ['신나는', '기분 전환되는', '강렬한'],
    },
    travel: {
        title: '여행 예시',
        mood: 'happy',
        text: '친구들과 여행을 떠나는 날이에요. 풍경이 바뀌는 길에서 기분 좋게 들을 수 있는 밝은 인디 팝과 로드트립 분위기의 곡이 필요해요.',
        vibes: ['신나는', '기분 전환되는', '따뜻한'],
    },
};
